...
1. Write and test a method **harmonicSum** with the following specification.
...
<HR>
1. Write and test a method called **geometricSum** with the following specification.
...
<HR>
1. Write and test a method **multPos** that takes in two positive integers and returns their product.
