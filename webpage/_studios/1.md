...
`HiOne`
  ...
  > Sample output: `Hi Ron.  How are you?` (assuming `Ron` was supplied as input)
...
`HiFour`
  ...
  > Sample output: `Greetings Cormen, Leiserson, Rivest, and Stein.` **Be sure to put in** <ahref="http://en.wikipedia.org/wiki/Serial_comma">proper punctuation</a> **to separate the names.**
...
for each letter grade). Consider using the [mod operator] (http://www.cafeaulait.org/course/week2/15.html "mod operator") `%` to compute the rightmost
...
* The number of times you have been to [Ted Drewes][1]
* Whether you like [vanilla frozen custard][2] or not
* The number of people you can take in your car
* The price of a small cup of [vanilla frozen custard][3]
* The name of your favorite [special][3] offering from
[Ted Drewes][1]
* The [address][4] of the [Ted Drewes][1] that is closest to campus
* The percentage of calories in [vanilla frozen custard][2] that come from fat
* The probability that you will see a friend at [Ted Drewes][1] when you go there
...
[1]: (http://www.teddrewes.com/home/default.aspx "Ted Drewes")
[2]: (http://www.teddrewes.com/sitecontent/dynamiccontent.aspx?pid=76&uid=D18D6B6C-7948-4C04-8F59-12F77F9F3F49 "vanilla frozen custard")
[3]: (http://www.teddrewes.com/sitecontent/Specials.aspx "Special")
[4]: (http://www.teddrewes.com/sitecontent/dynamiccontent.aspx?pid=92&uid=1FA7B06F-39EC-4A8E-8A31-23EE0B783705 "Ted Drewes Address")
